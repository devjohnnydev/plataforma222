...
urlpatterns = [
    ...
    path('api/sticky-notes/', views.sticky_notes_api_view, name='sticky_notes'),
    path('api/sticky-notes/<int:note_id>/', views.sticky_notes_api_view, name='sticky_notes_detail'),
]
