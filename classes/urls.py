...
urlpatterns = [
    ...
    path('classes/<int:pk>/lessons/<int:lesson_pk>/material/<int:material_pk>/delete/', views.delete_lesson_material_view, name='delete_lesson_material'),
    path('classes/<int:pk>/lessons/<int:lesson_pk>/material/<int:material_pk>/post-stream/', views.post_material_to_mural_view, name='post_material_to_mural'),
